// Understand-only topic selector controller
...
(function() {
    ...
    function initializeTopicSelector() {
        const topicChooser = document.getElementById('topicChooser');
        ...
        // Hide all top-level articles initially
        ...
        // Hide old Jump to Section UI (keep hidden throughout)
        const jumpSection = document.getElementById('understandJumpSection');
        if (jumpSection) {
    ...
    function selectTopic(topicId) {
        ...
        // Hide supporting sections during topic view
        const howToSection = document.getElementById('understandHowTo');
        if (howToSection) {
            howToSection.style.display = 'none';
        }

        const aiCallout = document.getElementById('understandAiCallout');
        if (aiCallout) {
        ...
        const specializedGuides = document.getElementById('understandSpecializedGuides');
        if (specializedGuides) {
            specializedGuides.style.display = 'none';
        }
    }
    ...
    function backToTopics() {
        ...
        const specializedGuides = document.getElementById('understandSpecializedGuides');
        if (specializedGuides) {
            specializedGuides.style.display = 'block';
        }

        // Keep Jump to Section hidden (do not restore)
        ...
        const chooserHeading = document.getElementById('topicChooserHeading');
        if (chooserHeading) {
